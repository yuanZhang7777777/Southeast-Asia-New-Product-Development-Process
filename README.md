...
开发主线以 `lxc/integrated-workflow` 为基线；当前开发环境部署工作分支提交 `d8e637a`，访问地址为 [http://139.224.2.166:18081](http://139.224.2.166:18081)，开发库为 `e1f2a3b4c678 (head)`。页面已拆分刊登任务 / 周期观察并收紧筛选和只读纠错；2,237 个历史关注键的单人到货试运行已在 2026-07-23 向刘学城成功投放 1 张卡，未写业务表。生产环境仍运行 `b373d65`，本次未连接或变更生产。
