...
- Completed history remains attributed to its original owner when an operator transfers or leaves. A manager may transfer future Item responsibility, but the exact cutover for unfinished periods and queued reminders remains an open business question; never implement transfer by rewriting historical ownership.
