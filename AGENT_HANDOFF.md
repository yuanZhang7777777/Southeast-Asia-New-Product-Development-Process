...
- New and bulk review records are claim-scoped. Historical reviews with a null `claim_record_id` apply only to claims that already existed when the review was created.
